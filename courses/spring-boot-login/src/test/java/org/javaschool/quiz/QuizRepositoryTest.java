...
class QuizRepositoryTest {
    ...
    // 풀이 기록에는 남긴 사람이 있어야 하므로 스터디원도 함께 저장합니다.
    @Autowired
    ...
    void storesKoreanQuestionAndAnswerAttemptInMySql() {
        ...
        StudyMember member = studyMemberRepository.saveAndFlush(StudyMember.join("민수", "저장용-해시-값"));

        AnswerAttempt attempt = answerAttemptRepository.saveAndFlush(AnswerAttempt.record(question, member, 1));
        ...
        assertThat(answerAttemptRepository.countByMember(member)).isEqualTo(1);
    }
}
