...
const loadQuestion = async () => {
    ...
    questionMessage.textContent = '내 퀴즈 API에 요청하는 중...';
    ...
    try {
        ...
        questionMessage.textContent = error.message || '내 퀴즈 API에 연결할 수 없습니다.';
    } finally {
...
const submitAnswer = async (event) => {
    ...
    try {
        ...
        answerMessage.textContent = error.message || '내 퀴즈 API에 연결할 수 없습니다.';
        answerButton.disabled = false;
    }
};
